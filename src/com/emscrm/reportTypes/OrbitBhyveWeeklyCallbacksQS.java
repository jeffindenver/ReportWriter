...
public class OrbitBhyveWeeklyCallbacksQS extends QueueSummaryReport {
    private final static String reportName = "Orbit Bhyve Callbacks Weekly";
    private final Map<String, String> tableNames = Map.of("Summary", "CallbacksTable");

    public OrbitBhyveWeeklyCallbacksQS() {
